...
public class CatalogDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        catalogService.createSection(uid, course.id(),
                new CourseRequests.CreateSection("Tuần 1-4: Nền tảng & Listening", 1, null, null, null, null));
        catalogService.createSection(uid, course.id(),
                new CourseRequests.CreateSection("Tuần 5-8: Reading & Writing Task 1", 2, null, null, null, null));
        catalogService.createSection(uid, course.id(),
                new CourseRequests.CreateSection("Tuần 9-12: Luyện đề & thi thử", 3, null, null, null, null));
