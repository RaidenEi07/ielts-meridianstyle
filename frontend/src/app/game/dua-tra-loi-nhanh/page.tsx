...
export default function QuickRaceGamePage() {
  ...
  return (
    <div className="min-h-screen bg-bg">
      <PageHeader title="🏁 Đua trả lời nhanh" backHref="/vao-hoc/tieu-hoc" backLabel="Tiểu học" />

      <main className="mx-auto max-w-3xl px-6 py-8">
        <p className="text-sm text-muted">
          Trả lời nhanh trước khi hết giờ! Mỗi câu có 15 giây, trả lời đúng để ghi điểm.
        </p>
